...
# inspired by: https://stackoverflow.com/questions/30300876/django-use-layermapping-to-update-an-existing-model
...
localarea_mapping = {
    ...
    'c19_p14_t': 'C19_P14_T',
    'p14_100k': 'P14_100k',
    'p14_100k_t': 'P14_100k_T',
    'ire_incp14': 'Ire_IncP14',
    'eventdate': 'EventDate',
    'geom': 'MULTIPOLYGON',
}
...
def download_zip():
    ...
    try:
        shutil.rmtree(path)
        dload.save_unzip("https://opendata-geohive.hub.arcgis.com/datasets/27d401c9ae084097bb1f3a69b69462a1_0.zip")
